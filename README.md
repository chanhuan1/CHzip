...
[![版本](https://img.shields.io/badge/版本-v3.4-2786dc?style=flat-square)](https://github.com/chanhuan1/CHzip/releases)
...
1. 在飞牛应用中心手动安装 `CHzip_3.4_search-fixed_<架构>.fpk`（x86_64 / arm64）。
